...
## 나의 풀이 
첫 접근은 recursive를 이용한 방식을 생각했다. 그러나 런타임에러가 떠서 다음 접근으로 memoization기법을 이용했다. 나름 잘 생각했다 생각했지만, 문제에서 요구한 것은 memoization도 아니었기에 효율성에서 광탈했다. 결국, top down 방식으로 홀수면 1을 더하고, 짝수면 넘어가는 방식을 이용하여 풀어낼 수 있었다. 이런 문제가 제일 어려운 것 같다..